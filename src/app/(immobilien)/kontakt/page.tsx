...
export default function KontaktPage() {
  return (
    <section className="duration-100 mx-auto px-2 py-6 mt-16 flex flex-col gap-8 rounded ">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="duration-100 w-full md:w-1/2 space-y-6 p-6 md:p-8 rounded bg-secondary dark:bg-secondary-dark  flex flex-col justify-center">
        ...
        <div className="w-full md:w-1/2 flex items-center">
          <div className="w-full h-96 md:h-[480px] rounded overflow-hidden bg-white/70 dark:bg-bg-d/70">
            <ContactMap />
          </div>
        </div>
      </div>
