...
export default function KontaktPage() {
  return (
    <section className="max-w-4xl mx-auto px-2 py-6 mt-16 flex flex-col gap-8 md:flex-row md:gap-8 bg-bg-l dark:bg-bg-d rounded-2xl border border-primary/30 shadow-xl">
      {/* Datos de contacto */}
      <div className="w-full md:w-1/2 space-y-6 p-6 md:p-8 rounded-2xl bg-white/80 dark:bg-black/20 border border-primary/20 shadow-md flex flex-col justify-center">
      ...
      <div className="w-full md:w-1/2 flex items-center">
        <div className="w-full h-96 md:h-[480px] rounded-2xl overflow-hidden shadow-lg border border-primary/20 bg-white/70 dark:bg-bg-d/70">
          <ContactMap />
        </div>
      </div>
    </section>
