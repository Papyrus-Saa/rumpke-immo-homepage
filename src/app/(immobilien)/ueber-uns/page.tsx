...
export default function UeberUnsPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 py-6 bg-white/80 dark:bg-black/30 rounded-3xl shadow-xl animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-start md:gap-10">
        ...
        <div className="w-full space-y-5 mt-4 md:mt-0 flex flex-col items-center md:items-start md:w-2/3">
          <h1 className="text-xl md:text-2xl font-bold mb-2 tracking-wide text-center md:text-left text-primary">Über mich</h1>
          <p className="text-base md:text-lg font-normal tracking-wide text-center md:text-left max-w-2xl">
          ...
          <p className="italic text-base md:text-lg font-medium tracking-wide text-center md:text-left max-w-2xl">
