...
export default function MietePage() {
  ...
  const filteredProperties = properties.filter((p: any) => p.operationType === OperationType.RENT);
  const title = 'Alle Miet-Immobilien';
    ...
    return (
      <main className="px-2 py-6">
        ...
        <div className="flex items-center justify-center min-h-[40vh] w-full">
          <span className="text-lg font-semibold text-gray-500 dark:text-gray-300">Zurzeit gibt es keine Immobilien zur Miete.</span>
        </div>
      </main>
    );
  }
