...
export default function () {
  return (
    <main className="flex flex-col min-h-screen pt-32 sm:pt-52">
      ...
      <h1 className="text-4xl mb-5">Anmelden</h1>
      ...
      <div className="flex flex-col">
        ...
        <Link
          href="/auth/neues-konto"
          className="text-center hover:text-primary-dark dark:hover:text-primary transition-all duration-100">
