  ...
  return (
    <div className="flex items-center gap-3">
      <input
        ...
        required={required}
        {...rest}
        className={`w-5 h-5 text-primary bg-card-bg-l dark:bg-card-bg-d border-admin-border-l dark:border-admin-border-d rounded focus:ring-2 focus:ring-orange-600 ${error ? 'border-error' : ''}`}
      />
